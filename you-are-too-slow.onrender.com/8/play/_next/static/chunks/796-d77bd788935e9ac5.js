    ...
    [796], {
                ...
                return new Promise((function(t, e) {
                        ...
                        void 0 !== navigator.maxTouchPoints ? function() {
                            ...
                            try {
                                window.indexedDB.open(t, 1).onupgradeneeded = function(e) {
                                    var r, o, i = null === (r = e.target) || void 0 === r ? void 0 : r.result;
                                    try {
                                        ...
                                        var a = u;
                                        return u instanceof Error && (a = null !== (o = u.message) && void 0 !== o ? o : u), n("string" === typeof a && /BlobURLs are not yet supported/.test(a))
                                    } finally {
                    ...
                    function a() {
                        navigator.webkitTemporaryStorage.queryUsageAndQuota((function(t, e) {
                            n(e < function() {
                                var t = window;
                                return void 0 !== t.performance && void 0 !== t.performance.memory && void 0 !== t.performance.memory.jsHeapSizeLimit ? performance.memory.jsHeapSizeLimit : 1073741824
                            }())
                        }), (function(t) {
                    ...
                    function u() {
                        void 0 !== self.Promise && void 0 !== self.Promise.allSettled ? a() : (0, window.webkitRequestFileSystem)(0, 1, (function() {
                            n(!1)
                        }), (function() {
                            n(!0)
                        }))
                        ...
                        return void 0 !== t && 0 === t.indexOf("Apple") && o(37)
                    })() ? (r = "Safari", i()) : function() {
                        var t = navigator.vendor;
                        return void 0 !== t && 0 === t.indexOf("Google") && o(33)
                    }() ? (r = function() {
                        var t = navigator.userAgent;
                        return t.match(/Chrome/) ? void 0 !== navigator.brave ? "Brave" : t.match(/Edg/) ? "Edge" : t.match(/OPR/) ? "Opera" : "Chrome" : "Chromium"
                    }(), u()) : void 0 !== document.documentElement && void 0 !== document.documentElement.style.MozAppearance && o(37) ? (r = "Firefox", n(void 0 === navigator.serviceWorker)) : void 0 !== navigator.msSaveBlob && o(39) ? (r = "Internet Explorer", n(void 0 === window.indexedDB)) : e(new Error("detectIncognito cannot determine the browser"))
                }))
            }
        },
        4298: function(t, e, r) {
        ...
        14450: function(t, e, r) {
            ...
            l.addData = function(t) {
                ...
                var h = 0;
                for (l = 0; l < n.length; l++) h += n[l].dataCount;
                ...
                for (; !(u.getLengthInBits() >= 8 * h) && (u.put(s.PAD0, 8), !(u.getLengthInBits() >= 8 * h));) u.put(s.PAD1, 8);
                ...
                for (var r = 0, n = 0, o = 0, i = new Array(e.length), s = new Array(e.length), l = 0; l < e.length; l++) {
                    var f = e[l].dataCount,
                        h = e[l].totalCount - f;
                    n = Math.max(n, f), o = Math.max(o, h), i[l] = new Array(f);
                    ...
                    for (g = 0; g < s[l].length; g++) {
                        var m = g + d.getLength() - s[l].length;
                        s[l][g] = m >= 0 ? d.get(m) : 0
                    }
                }
                var v = 0;
                ...
                var p = new Array(v),
                    w = 0;
                for (g = 0; g < n; g++)
                    for (l = 0; l < e.length; l++) g < i[l].length && (p[w++] = i[l][g]);
                for (g = 0; g < o; g++)
                    for (l = 0; l < e.length; l++) g < s[l].length && (p[w++] = s[l][g]);
                return p
            }, t.exports = s
        },
        17611: function(t, e, r) {
            ...
            o.RS_BLOCK_TABLE = [
                ...
                for (var n = r.length / 3, i = new Array, a = 0; a < n; a++)
                    for (var u = r[3 * a + 0], s = r[3 * a + 1], l = r[3 * a + 2], f = 0; f < u; f++) i.push(new o(s, l));
                return i
        ...
        88632: function(t, e, r) {
            ...
            var s = {
                ...
                f = (0, i.forwardRef)((function(t, e) {
                    ...
                    return a.default.createElement("svg", n({}, h, {
                        height: s,
                        ref: e,
                        viewBox: "0 0 " + f + " " + f,
                        width: s
            ...
            f.displayName = "QRCodeSvg", f.propTypes = s, f.defaultProps = l, e.default = f
        },
        1653: function(t, e, r) {
            "use strict";
            var n = Object.assign || function(t) {
            ...
            var h = {
                ...
                g = (0, u.forwardRef)((function(t, e) {
                    var r = t.bgColor,
                        ...
                        c = new o.default(-1, i.default[u]);
                    c.addData(h), c.make();
                    var d = c.modules;
                    return s.default.createElement(l.default, n({}, g, {
                        bgColor: r,
...
//# sourceMappingURL=796-d77bd788935e9ac5.js.map